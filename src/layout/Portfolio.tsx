        ...
        <>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="h-10" viewBox="0 0 496 512">
            <path
              ...
              className="fill-port-light-muted dark:fill-[#ABB2BF]"
            />
          </svg>
        </>
      ),
      ...
      <Disclosure>
        {({ open, close }) => (
          <Fragment>
            ...
            <Disclosure.Panel className="lg:hidden fixed transition-all left-0 right-0 w-full z-20 h-full bg-port-light-surface dark:bg-port-bg">
              <>
