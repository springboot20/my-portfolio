...
export default function HomePageComponent() {
  ...
  useSearchEngineOptimization({
    title: 'Abbas | Web Developer & UI Specialist',
    description:
      'Abbas is a web developer with a zeal for crafting intuitive, responsive digital experiences and building scalable, high-performance applications.',
    canonical: baseUrl,
    keywords: [
      'Abbas',
      'Web Developer',
    ...
    structuredData: {
      ...
      data: {
        ...
        url: baseUrl,
        sameAs: [
          'https://github.com/springboot20',
          'https://linkedin.com/in/abbas-yunus-70b65533a',
        ],
      },
    },
  });
        ...
        <SlideIn>
          <div className='space-y-7'>
            <motion.div initial='hidden' animate='visible' className='overflow-hidden'>
              <h1 className='text-3xl text-gray-900 dark:text-white font-bold font-fira-code leading-normal cursor-hover'>
    ...
    <section className='py-12'>
      <div className='w-full space-y-10'>
        ...
        <div className='flex flex-col lg:flex-row lg:items-start gap-9'>
          ...
          <div className='grid grid-cols-2 xl:grid-cols-3 flex-1 gap-2.5'>
            {React.Children.toArray(
      ...
      <div className='w-full space-y-10'>
        <div className='flex items-center space-x-2 shrink-0 flex-1'>
          <motion.h2
            ...
            animate='animate'
            className='text-port-light-text dark:text-white font-medium font-fira-code text-2xl'>
            <span className='text-port-light-text dark:text-port-primary'>#</span>contacts
          </motion.h2>
          <motion.div
            variants={{
              ...lineVariants,
